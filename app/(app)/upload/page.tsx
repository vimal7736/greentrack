      ...
      <div className="grid grid-cols-4 gap-2 lg:gap-4">
        {["Upload", "Processing", "Review", "Result"].map((s, i) => {
          ...
          return (
            <div
              key={s}
              className={`relative flex flex-col items-center gap-1.5 lg:gap-2 py-2.5 lg:py-3 rounded-xl transition-all duration-300 ${
                active ? "neu-inset" : done ? "neu-raised opacity-70" : "neu-raised opacity-40"
              }`}
            >
              <div className={`w-5 h-5 lg:w-6 lg:h-6 rounded-full flex items-center justify-center text-[9px] lg:text-[10px] font-black transition-colors ${
        ...
        <div className="space-y-8 animate-scale-in">
              ...
              {BILL_TYPES.map(({ key, label, sub, icon }) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative flex flex-col items-center justify-center gap-2 lg:gap-3 p-4 lg:p-6 rounded-2xl lg:rounded-[2rem] transition-all duration-500 overflow-hidden ${
                      active
                        ? "active-selection"
                  ...
                  >
                    ...
                    <div className={`relative z-10 w-9 h-9 lg:w-12 lg:h-12 rounded-xl lg:rounded-2xl flex items-center justify-center transition-all duration-500 ${
                      active
                    ...
                    <div className="relative z-10 flex flex-col items-center">
                      <span className={`text-[10px] lg:text-[11px] font-black uppercase tracking-wider lg:tracking-widest transition-colors ${
          ...
          <div className="space-y-6">
            ...
            <div
              ...
              className={`group relative overflow-hidden rounded-2xl lg:rounded-[2.5rem] p-8 lg:p-16 text-center transition-all duration-700 cursor-pointer ${
                dragOver
            ...
            >
              <div className="relative z-10 flex flex-col items-center">
                <div className={`w-14 h-14 lg:w-20 lg:h-20 rounded-2xl lg:rounded-3xl mb-4 lg:mb-6 flex items-center justify-center transition-all duration-700 ${
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 lg:p-6 rounded-2xl lg:rounded-3xl glass-green border-none shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8">
              <div className="space-y-2 lg:space-y-3">
                ...
                <input
                  ...
                  className="w-full bg-bg-inset/50 border-2 border-transparent rounded-xl lg:rounded-[1.5rem] px-4 lg:px-6 py-3.5 lg:py-4 text-sm font-black focus:border-gt-green-500 focus:bg-white transition-all outline-none"
              ...
              <div className="space-y-2 lg:space-y-3">
                ...
                <div className="relative">
                  <input
                    ...
                    style={{ color: "var(--text-primary)" }}
                  />
                  <span className="absolute right-4 lg:right-6 top-1/2 -translate-y-1/2 text-xs font-black opacity-30">GBP</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2 lg:space-y-3">
              ...
              <div className="relative group">
                <input
                  ...
                  placeholder="0"
                  className="w-full bg-bg-inset/50 border-2 border-transparent rounded-xl lg:rounded-[2rem] px-5 lg:px-8 py-4 lg:py-6 text-2xl lg:text-3xl font-black focus:border-gt-green-500 focus:bg-white transition-all outline-none pr-20 lg:pr-24"
                  style={{ color: "var(--text-primary)" }}
                />
                <div className="absolute right-4 lg:right-8 top-1/2 -translate-y-1/2 flex items-center gap-2 lg:gap-3">
                  <span className="text-xs lg:text-sm font-black uppercase tracking-widest opacity-30">{unit}</span>
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-xl bg-white shadow-sm flex items-center justify-center border border-border-subtle group-hover:scale-110 transition-transform">
